...
const config_field_t config_fields[] = {
    ...
    {"delegates_enabled", offsetof(config_t, delegates_enabled), sizeof(int), 0, CFG_BOOL,
     RELOAD_HOT, FGROUP_ADVANCED},
    {"prompt_manager_block_enabled", offsetof(config_t, prompt_manager_block_enabled), sizeof(int),
     0, CFG_BOOL, RELOAD_HOT, FGROUP_ADVANCED},
    {"prompt_manager_review_enabled", offsetof(config_t, prompt_manager_review_enabled),
     sizeof(int), 0, CFG_BOOL, RELOAD_HOT, FGROUP_ADVANCED},
